...
const users = [{
  id: 51, first_name: 'Cozmo', last_name: 'Harler', email: 'charler1e@opensource.org', gender: 'Male', image: 'https://robohash.org/etaccusantiumet.png?size=50x50&set=set1',
},
{
...
export const company3 = {
  name: 'fiverr', users, events, promotions, image: 'https://assetsv2.fiverrcdn.com/assets/v2_globals/fiverr-logo-new-green-64920d4e75a1e04f4fc7988365357c16.png',
};
