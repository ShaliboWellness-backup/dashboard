...
const EventDialog = (props) => {
    ...
    const {title, instructor, building, room, totalSpots, description, image, date} = values

    const formData = {title, instructor, building, room, totalSpots, description, image, date}
